...
const Result = () => {
  ...
  return (
    ...
    >
      ...
      {!isImageLoaded && (
        <div className="text-sm p-0.5 mt-10 rounded-full flex w-full max-w-xl bg-neutral-500 text-white">
          <input
      ...
      {isImageLoaded && (
        <div className="flex gap-2 flex-wrap justify-center text-white text-sm p-05 mt-10 rounded-full">
          <p
            onClick={() => {
